...
\subsection{Lookahead assertion}
\begin{frame}[fragile]
Positive and negative lookahead assertion
\begin{lstlisting}
>>> singer = "Michael Jackson"
>>> player = "Michael Jordan"
>>> player_pattern = "Michael (?=Jordan)"
>>> player_matched = re.match(player_pattern, player)
>>> player_matched
...
>>> non_player_matched = re.match(non_player_pattern, singer)
>>> non_player_matched
<_sre.SRE_Match object; span=(0, 8), match='Michael '>
>>>
\end{lstlisting}
